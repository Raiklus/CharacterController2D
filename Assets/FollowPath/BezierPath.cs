...
{
    public int SEGMENTS_PER_CURVE = 10;
    ...
    */
	...
	public List<Vector3> GetDrawingPoints(BezierInterpolationMode _mode)
	{
		switch(_mode)
		{
		case BezierInterpolationMode.Mode0: return GetDrawingPoints0();
		case BezierInterpolationMode.Mode1: return GetDrawingPoints1();
		case BezierInterpolationMode.Mode2: return GetDrawingPoints2();
		}
		return null;
	}
    /**
...
public enum BezierInterpolationMode
{
	Mode0,
	Mode1,
	Mode2
